...
def parse_args():
    ...
    parser.add_argument('--sigma', default=2.0, type=float, help='decay rate for positive pair distance weighting')
    parser.add_argument('--cn_percentile', default=95.0, type=float, help='percentile threshold for excluding high-CN negative pairs')
    # random walk related
    ...
    parser.add_argument('--no_weighting', action='store_true', default=False,
                    help='disable PW-DNE weighting (reproduces original unweighted DNE)')
    # others
