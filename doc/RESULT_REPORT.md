...
* Each patient carries a survival time (`survival_day`) and status (`survival_status`: 0 = alive/censored, 1 = dead), plus clinical fields (tissue type, HPV status, recurrence).

The 16 cell types are three lineages: 
